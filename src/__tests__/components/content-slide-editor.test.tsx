...
describe("ContentSlideEditor", () => {
  ...
  function renderEditor(slide: ContentSlide = makeSlide(), showNotes = false) {
    return render(
      <ContentSlideEditor
        slide={slide}
        onChange={onChange}
  ...
  it("delegates presenter notes toggling to the parent", () => {
    renderEditor();
    fireEvent.click(screen.getByRole("button", { name: /presenter notes/i }));
